...
class AiModelDetail(SnowflakeBase, AiModelBase, table=True):
   ...
   model_type: int = Field(nullable=False, sa_column_kwargs={"name": "model_type"})
...
class UserWsBaseModel(SQLModel):
    user_id: int = Field(nullable=False, sa_type=BigInteger(), sa_column_kwargs={"name": "user_id"})
    ws_id: int = Field(nullable=False, sa_type=BigInteger(), sa_column_kwargs={"name": "ws_id"})
    role: str = Field(default="member", sa_column_kwargs={"name": "role"})
    create_time: int = Field(default=0, sa_type=BigInteger(), sa_column_kwargs={"name": "create_time"})
