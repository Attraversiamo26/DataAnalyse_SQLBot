...
if (__VLS_ctx.item.error) {
    ...
    if (__VLS_ctx.list.length > 0) {
        ...
        for (const [ele, index] of __VLS_getVForSourceType((__VLS_ctx.list))) {
            ...
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
            for (const [word, index2] of __VLS_getVForSourceType((ele.words))) {
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    key: (index2),
            ...
            __VLS_asFunctionalDirective(__VLS_directives.vDompurifyHtml)(null, { ...__VLS_directiveBindingRestFields, value: (ele.description) }, null, null);
        }
    }
}
var __VLS_2;
