...
export function treeParentWeight(tree, pWeight) {
    const pWeightResult = {};
    weightCheckCircle(tree, pWeightResult, pWeight);
    return pWeightResult;
}
export function weightCheckCircle(tree, pWeightResult, pWeight) {
    _.forEach(tree, (node) => {
...
export function sortCircle(tree, sortType) {
...
export const sortPer = (subTree, sortType) => {
