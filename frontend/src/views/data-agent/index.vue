          ...
          <div class="basic-stats-section">
            <el-form :model="dataSourceForm" label-width="80px" class="data-source-form">
              <el-form-item label="数据源">
                <el-select v-model="dataSourceForm.datasource_id" placeholder="请选择数据源" @change="handleDatasourceChange" :loading="isLoadingDatasources">
                  <el-option v-for="datasource in datasources" :key="datasource.id" :label="datasource.name" :value="datasource.id" />
                </el-select>
              </el-form-item>
              
              <el-form-item label="表名">
                <el-select v-model="dataSourceForm.table_name" placeholder="请选择表名" :loading="isLoadingTables">
                  <el-option v-for="table in tables" :key="table.id" :label="table.table_name" :value="table.table_name" />
                </el-select>
              </el-form-item>
            ...
            <div v-if="analysisResult" class="analysis-result">
              ...
              <div v-if="analysisResult.result" class="generated-charts-section">
                ...
                <div class="generated-charts">
                  <el-card v-for="(chart, key) in getGeneratedCharts()" :key="key" class="chart-item-card">
...
const analyzeData = async () => {
  ...
  try {
    const request: DataAnalysisRequest = {
      ...
      datasource_id: dataSourceForm.datasource_id ? Number(dataSourceForm.datasource_id) : undefined,
